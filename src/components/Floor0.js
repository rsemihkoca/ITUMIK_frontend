...
export const Floor0 = () => {
  return (
    <div className="floor mx-4 rounded-xl pt-2 sm:pt-8  min-w-[240vw] sm:min-w-[1200px] my-8 sm:my-0">
      ...
      <div className="h-full px-4 grid grid-cols-11 grid-rows-5  min-w-[200vw] sm:min-w-[1200px] ">
