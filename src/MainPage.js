          ...
          <div className="2xl:h-[95vh] flex 2xl:items-center">
            <div className="w-full rounded-2xl bg-[#002855]/[0.5] sm:pt-12 pb-16">
              ...
              <div className="flex justify-center flex-wrap gap-y-8 sm:gap-y-4 items-center gap-x-10">
                <MainPageCard title={t('floor0')} percentage={90} floorId={t('mainCard1FloorId')} />
                <MainPageCard title={t('floor1')} percentage={70} floorId={t('mainCard1FloorId')} />
                <MainPageCard title={t('floor2')} percentage={50} floorId={t('mainCard1FloorId')} />
                <MainPageCard title={t('floor3')} percentage={20} floorId={t('mainCard1FloorId')} />
              </div>
            </div>
          </div>
        </div>
